# This Makefile is for the WWW::RSSFeed extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/RSSFeed.pm]
#     AUTHOR => q[Kunal Jaiswal<kunal.jaiswal@yahoo.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[WWW::RSSFeed]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/WWW/RSSFeed.pm]
...
TO_INST_PM = lib/WWW/RSSFeed.pm

PM_TO_BLIB = lib/WWW/RSSFeed.pm \
...
DISTNAME = WWW-RSSFeed
DISTVNAME = WWW-RSSFeed-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/WWW/RSSFeed.pm $(INST_MAN3DIR)/WWW::RSSFeed.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               WWW-RSSFeed' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for creating RSS feeds for your website.' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Kunal Jaiswal<kunal.jaiswal@yahoo.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for creating RSS feeds for your website.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Kunal Jaiswal&lt;kunal.jaiswal@yahoo.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WWW/RSSFeed.pm blib/lib/WWW/RSSFeed.pm 
